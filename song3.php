            ...
            <div class="container px-4 ">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        echo "<h2 class='red-text'>HOW GREAT THOU ART!</h2>";
                        echo "<p class='lead'>Charley Hall</p>";
                        echo "<p class='lead'>Cappo: 4</p>";

                        echo "<p>[INTRO]</p>";
                        echo "<pre class='tab4'>G    Gsus</pre>";
                        echo "<br/>";

                        echo "<p>[VERSE 1]</p>";

                        echo "<pre class='tab4'>    G             C/G       </pre>";
                        echo "<p>O Lord my God, When I in awesome wonder,</p>";
                        echo "<pre class='tab4'>         G               D/F#      G   </pre>";
                        echo "<p>consider all the Worlds Thy hand hath made.</p>";
                        echo "<pre class='tab4'>    G              C/G       </pre>";
                        echo "<p>I see the stars, I hear the rolling thunder</p>";
                        echo "<pre class='tab4'>               G       D/F#     G      </pre>";
                        echo "<p>Thy pow'r throughout the universe displayed</p>";
                        echo "<br/>";

                        echo "<p>[CHORUS]</p>";

                        echo "<pre class='tab4'>             G        C/G        G     </pre>";
                        echo "<p>Then sings my soul, my Savior God, to Thee</p>";
                        echo "<pre class='tab4'>               Am7                 G</pre>";
                        echo "<p>How great Thou art! How great Thou art!</p>";
                        echo "<pre class='tab4'>                      C/G             G</pre>";
                        echo "<p>Then sings my soul, my Savior God, to Thee</p>";
                        echo "<pre class='tab4'>               Am7    C/G            G</pre>";
                        echo "<p>How great Thou art! How great Thou art!</p>";
                        echo "<br/>";
                        ...
                        echo "<pre class='tab4'>    G             C/G       </pre>";
                        echo "<p>And when I think that God, His Son not sparing</p>";
                        echo "<pre class='tab4'>         G               D/F#      G   </pre>";
                        echo "<p>Sent Him to die, I scarce can take it in</p>";
                        echo "<pre class='tab4'>    G              C/G       </pre>";
                        echo "<p>That on the cross, my burden gladly bearing</p>";
                        echo "<pre class='tab4'>               G       D/F#     G      </pre>";
                        echo "<p>He bled and died to take away my sin</p>";
                        echo "<br/>";
                        ...
                        echo "<pre class='tab4'>    G             C/G       </pre>";
                        echo "<p>When Christ shall come, with shouts of acclamation</p>";
                        echo "<pre class='tab4'>         G               D/F#      G   </pre>";
                        echo "<p>And take me home, what joy shall fill my heart</p>";
                        echo "<pre class='tab4'>    G              C/G       </pre>";
                        echo "<p>Then I shall bow in humble adoration</p>";
                        echo "<pre class='tab4'>               G       D/F#     G      </pre>";
                        echo "<p>And there proclaim, My God, how great You are!</p>";
                        echo "<br/>";
